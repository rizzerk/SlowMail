...
const styles = StyleSheet.create({
  ...
  empty:      { fontFamily: 'monospace', fontSize: 13, color: Colors.mutedInk, textAlign: 'center', marginTop: 40 },
  ...
  toText:     { fontFamily: 'monospace', fontWeight: 'bold', fontSize: 13, color: Colors.darkInk },
  ...
  dateText:   { fontFamily: 'monospace', fontSize: 11, color: Colors.mutedInk, marginTop: 6 },
});
