...
const styles = StyleSheet.create({
  ...
  back:         { fontFamily: 'monospace', fontSize: 13, color: Colors.mutedInk },
  editBtn:      { fontFamily: 'monospace', fontSize: 13, color: Colors.darkInk, textDecorationLine: 'underline' },
  ...
  avatarText:   { fontFamily: 'monospace', fontWeight: 'bold', fontSize: 36, color: Colors.darkInk },
  card:         { margin: 20, backgroundColor: Colors.white, borderRadius: 16, borderWidth: 2, borderColor: Colors.darkInk, padding: 20 },
  fieldLabel:   { fontFamily: 'monospace', fontSize: 11, color: Colors.mutedInk, marginTop: 12, marginBottom: 2 },
  fieldValue:   { fontFamily: 'monospace', fontSize: 15, color: Colors.darkInk },
  input:        { borderBottomWidth: 1.5, borderColor: Colors.darkInk, paddingVertical: 6, fontSize: 14, fontFamily: 'monospace', color: Colors.darkInk, marginBottom: 4 },
  ...
  saveBtnText:  { fontFamily: 'monospace', fontWeight: 'bold', fontSize: 14, color: Colors.darkInk },
  ...
  logoutText:   { fontFamily: 'monospace', fontWeight: 'bold', fontSize: 15, color: Colors.darkInk },
});