...
const styles = StyleSheet.create({
  ...
  mono:         { fontFamily: Fonts.pixel, fontSize: 14, color: Colors.darkInk },
  back:         { fontFamily: Fonts.pixel,  fontSize: 13, color: Colors.mutedInk, marginTop: 10, textDecorationLine: 'underline' },
  ...
  actionBtnText:{ fontFamily: Fonts.pixel, fontWeight: 'bold', fontSize: 15, color: Colors.darkInk },
  keptNote:     { alignItems: 'center', padding: 12 },
  keptNoteText: { fontFamily: Fonts.pixel, fontSize: 14, color: Colors.darkInk },
});