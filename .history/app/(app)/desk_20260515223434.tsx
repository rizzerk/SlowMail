    ...
    <View style={styles.container}>
      ...
      {letters.length === 0 ? (
        <View style={styles.deskImgContainer}>
          ...
          <Text style={styles.subtitle}>Your desk is empty.</Text>
        </View>
      ) : (
        <Text style={styles.subtitle}>{letters.length} kept letter{letters.length !== 1 ? 's' : ''}</Text>
      )}
...
const styles = StyleSheet.create({
  ...
  deskImgContainer: { alignItems: 'center', justifyContent: 'center', flex: 1, paddingTop: 200 },
  deskImg:    { width: 600, height: 600 },
